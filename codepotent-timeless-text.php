 ...
 * Description: For phrases like "I have worked for n years in web dev" or "We have n years of combined experience" – this plugin keeps the numbers updated each year automatically. See the <a href="http://codepotent.com/classicpress/plugins/">docuemntation</a>.
 * Version: 2.0.0
 * Author: Code Potent
 * Author URI: https://codepotent.com
 * Plugin URI: https://codepotent.com/classicpress/plugins/
 * Text Domain: timeless-text
